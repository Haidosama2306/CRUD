    ...
    <div class="card-body">
        <form action="{{ route('user.postUpdateUser') }}" method="POST">
            ...
            <div class="input">
                ...
                <input type="text" placeholder="Favorite" id="favorite" name="favorite" value="{{ $user->favorite }}">
            </div>
            <div class="input">
                <label for="email">Email</label>
                <input type="text" placeholder="Email" id="email_address" value="{{ $user->email }}" name="email"
                    required autofocus>
            </div>
            <div class="input">
